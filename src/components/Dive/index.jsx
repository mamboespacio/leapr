...
const Dive = () => {
  ...
  useFrame((state) => {
    ...
    ref1.current.fontSize = mapRange(r1, 0, 1, 4, 6)
    ...
    ref2.current.fontSize = mapRange(r2, 0, 1, 4, 6)
    ...
    ref3.current.fontSize = mapRange(r3, 0, 1, 4, 6)
    ...
    ref4.current.fontSize = mapRange(r4, 0, 1, 4, 6)
